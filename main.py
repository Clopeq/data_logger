...
def main():
    ...
    producer_thread = Thread(target=producer_loop, args=(UI_REFRESHRATE, WRITER_QUE, UI_QUE, PRODUCER_CMD_OUT, PRODUCER_CMD_IN), daemon=True)
    ui_thread = Thread(target=ui_loop, args=(app.get_all_ui_elements(), UI_REFRESHRATE, UI_QUE, UI_CMD_OUT, UI_CMD_IN), daemon=True)
